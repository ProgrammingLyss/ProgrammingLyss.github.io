...
I have been in the Computer Science program at SNHU for four and a half years. When I started this program, I had no prior work experience in the field and very limited knowledge of its concepts. By completing the course work throughout the program, I've gained critically important skills such as collaborating in a team environment and communicating to stakeholders, which has prepared me to enter the workforce in the Computer Science field. Developing this ePortfolio has helped showcase my strengths through the presentation of enhanced artifacts in 3 categories: Software Design/Engineering, Algorithms and Data Structures, and Databases.

The artifacts featured in this ePortfolio were specifically chosen to demonstrate the full range of my Computer Science talents and abilities. The Software Design/Engineering artifact is a simple calculator application that demonstrates my abiity to conduct front-end development with Java. The Algorithms and Data Structures artifact is a mobile application that demonstrates my ability to conduct front-end development and front-end testing with Java. The Databases artifact is a dashboard application that demonstrates my ability to conduct full-stack development with Python, Jupyter Notebook, and MongoDB. This professional self-assessment demonstrates my mastery of Course Outcome 1: Employ strategies for building collaborative environments that enable diverse audiences to support organizational decision-making in the field of computer science.
...
[Mobile Application Before Enhancement](https://github.com/ProgrammingLyss/ProgrammingLyss.github.io/tree/main/Unenhanced%20Mobile%20Application)
...
[Dashboard Application Before Enhancement](https://github.com/ProgrammingLyss/ProgrammingLyss.github.io/tree/main/Unenhanced%20Dashboard%20Application)
